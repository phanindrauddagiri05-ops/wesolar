...
class Installation(models.Model):
    ...
    # Specific Used Materials matching Dispatched Items (for comparison)
    panels_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    structure_kit_used = models.CharField(max_length=20, choices=STRUCTURE_KIT_CHOICES, blank=True, null=True, default='Normal')
    inverter_kw_used = models.FloatField(default=0.0, blank=True, null=True)
    inverter_phase_type_used = models.CharField(max_length=20, choices=INVERTER_PHASE_TYPE_CHOICES, blank=True, null=True, default='Single Phase')
    ac_cable_red_used = models.FloatField(default=0.0, blank=True, null=True)
    ac_cable_black_used = models.FloatField(default=0.0, blank=True, null=True)
    dc_cable_red_black_used = models.FloatField(default=0.0, blank=True, null=True)
    la_cable_mtrs_used = models.FloatField(default=0.0, blank=True, null=True)
    pipes_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    earthing_kit_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    acdb_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    dcdb_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    mc4_connectors_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    long_l_bands_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    short_l_bands_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    t_bands_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    tapes_red_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    tapes_black_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    tags_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    nail_clamps_2side_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    nail_clamps_1side_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
    anchor_hardener_count_used = models.PositiveIntegerField(default=0, blank=True, null=True)
